...
public class FileHandler {
    ...
    //                     globalStudents.put(newStudent.getUserid(), newStudent);
    //                 }
    //             } else {
    ...
    //         JSONObject studentObj = new JSONObject();
    //         studentObj.put("studentID", student.getUserid());
    ...
    //     if (studentsInCourse.stream().noneMatch(s -> s.getUserid().equals(student.getUserid()))) {
    ...
    //     List<Student> studentsInCourse = loadCourseStudents(courseId, loadGlobalStudents());
    //     studentsInCourse.removeIf(s -> s.getUserid().equals(studentID));
    ...
    //             .map(s -> s.getUserid().equals(student.getUserid()) ? student : s)
