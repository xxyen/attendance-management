...
public class FileEncryptorDecryptorTest {
  ...
  // @Disabled
  @Test
  void test_generateEncryptedFile() throws Exception {
    String path = System.getProperty("user.dir") + "/testdata/testCourse/";
    String inputFile = path + "Professor_testCourse.json.temp";
    String encryptedFile = path + "Professor_testCourse.json";
    String decryptedFile = path + "decryptedTest.json";
